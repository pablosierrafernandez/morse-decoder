#ifndef PRODECIMIENTOS_H_INCLUDED
#define PRODECIMIENTOS_H_INCLUDED



#endif // PRODECIMIENTOS_H_INCLUDED
...
void codificar( struct Traduccion1 tradu[ALFABETO]){
...
void descodificar (struct Traduccion traduccion[ALFABETO]){
